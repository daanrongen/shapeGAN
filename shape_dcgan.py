...
def train_step(self, images):
    ...
    self.apply_gradients(zip(gradients_of_generator, generator.trainable_variables))
...
def train(dataset, epochs):
    for epoch in range(epochs):
        ...
        self.generate_and_save_images(generator, epoch + 1, seed)
    ...
    display.clear_output(wait=True)
    self.generate_and_save_images(generator, epochs, seed)
